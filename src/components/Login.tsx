    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white">Player Subsonic</h1>
          <p className="mt-2 text-gray-400">Entre no seu servidor Subsonic</p>
        </div>
        ...
        <div className="bg-gray-800 rounded-lg p-6 shadow-lg">
          ...
          <div className="mt-4 text-sm text-gray-400 text-center">
            <p>Precisa de ajuda? Consulte a <a href="http://www.subsonic.org/pages/api.jsp" target="_blank" rel="noreferrer" className="text-indigo-400 hover:underline">documentação da API Subsonic</a></p>
          </div>
        </div>
      </div>
    </div>
